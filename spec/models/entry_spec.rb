...
# Unit tests for Quake::Timesheets::Entry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Quake::Timesheets::Entry do
  let(:instance) { Quake::Timesheets::Entry.new }

  describe 'test an instance of Entry' do
    it 'should create an instance of Entry' do
      expect(instance).to be_instance_of(Quake::Timesheets::Entry)
    end
  end
